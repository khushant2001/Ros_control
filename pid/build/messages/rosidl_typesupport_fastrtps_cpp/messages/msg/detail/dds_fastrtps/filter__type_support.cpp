...
#include "messages/msg/detail/filter__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const messages::msg::Filter & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages::msg::Filter & ros_message)
{
  // Member: position
  cdr >> ros_message.position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages::msg::Filter;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages::msg::Filter *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages::msg::Filter *>(
    untyped_ros_message);
...
{
  return &messages::msg::typesupport_fastrtps_cpp::_Filter__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, Filter)() {
  return &messages::msg::typesupport_fastrtps_cpp::_Filter__handle;
}
