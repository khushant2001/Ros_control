...
#include "messages/msg/detail/refsignal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const messages::msg::Refsignal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages::msg::Refsignal & ros_message)
{
  // Member: setpoint
  cdr >> ros_message.setpoint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages::msg::Refsignal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages::msg::Refsignal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages::msg::Refsignal *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Refsignal__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const messages::msg::Refsignal *>(
...
static size_t _Refsignal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Refsignal(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Refsignal__callbacks = {
  "messages::msg",
  "Refsignal",
...
static rosidl_message_type_support_t _Refsignal__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Refsignal__callbacks,
...
{
  return &messages::msg::typesupport_fastrtps_cpp::_Refsignal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, Refsignal)() {
  return &messages::msg::typesupport_fastrtps_cpp::_Refsignal__handle;
}
