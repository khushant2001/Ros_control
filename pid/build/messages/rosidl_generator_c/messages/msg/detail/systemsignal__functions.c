...
messages__msg__Systemsignal__create()
{
  ...
  messages__msg__Systemsignal * msg = (messages__msg__Systemsignal *)allocator.allocate(sizeof(messages__msg__Systemsignal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(messages__msg__Systemsignal));
  bool success = messages__msg__Systemsignal__init(msg);
  if (!success) {
...
messages__msg__Systemsignal__destroy(messages__msg__Systemsignal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    messages__msg__Systemsignal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
messages__msg__Systemsignal__Sequence__init(messages__msg__Systemsignal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  messages__msg__Systemsignal * data = NULL;

  if (size) {
    data = (messages__msg__Systemsignal *)allocator.zero_allocate(size, sizeof(messages__msg__Systemsignal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = messages__msg__Systemsignal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        messages__msg__Systemsignal__fini(&data[i - 1]);
      }
...
messages__msg__Systemsignal__Sequence__fini(messages__msg__Systemsignal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      messages__msg__Systemsignal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  messages__msg__Systemsignal__Sequence * array = (messages__msg__Systemsignal__Sequence *)allocator.allocate(sizeof(messages__msg__Systemsignal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = messages__msg__Systemsignal__Sequence__init(array, size);
  if (!success) {
...
messages__msg__Systemsignal__Sequence__destroy(messages__msg__Systemsignal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    messages__msg__Systemsignal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
messages__msg__Systemsignal__Sequence__are_equal(const messages__msg__Systemsignal__Sequence * lhs, const messages__msg__Systemsignal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!messages__msg__Systemsignal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  messages__msg__Systemsignal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(messages__msg__Systemsignal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    messages__msg__Systemsignal * data =
      (messages__msg__Systemsignal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!messages__msg__Systemsignal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          messages__msg__Systemsignal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!messages__msg__Systemsignal__copy(
