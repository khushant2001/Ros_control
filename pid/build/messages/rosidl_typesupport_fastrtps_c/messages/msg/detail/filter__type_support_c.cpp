...
#include "messages/msg/detail/filter__rosidl_typesupport_fastrtps_c.h"
...
using _Filter__ros_msg_type = messages__msg__Filter;
...
size_t get_serialized_size_messages__msg__Filter(
  const void * untyped_ros_message,
...
static uint32_t _Filter__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_messages__msg__Filter(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages
size_t max_serialized_size_messages__msg__Filter(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages__msg__Filter;
    is_plain =
      (
...
static size_t _Filter__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages__msg__Filter(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages, msg, Filter)() {
